...
var openCassandraInternode = require('./openCassandraInternode');
...
const networkSecurityGroups = [
    ...
    },
    {
        ...
        "securityRules": [
        {
            "name": "AllowCassandraInternode",
            "id": "/subscriptions/ab12c345-def7-890g-a1b2-28fc0d22117e/resourceGroups/test-rg/providers/Microsoft.Network/networkSecurityGroups/aadds-nsg/securityRules/AllowCassandraInternode",
            "etag": "W/\"a1bb27cd-711f-4ede-b673-2fe8e7e07eee\"",
            "type": "Microsoft.Network/networkSecurityGroups/securityRules",
            "properties": {
                "provisioningState": "Succeeded",
...
describe('openCassandraInternode', function() {
    describe('run', function() {
        ...
        it('should PASS if security group has Cassandra Inter node TCP port 7000 not open to public', function(done) {
        ...
        it('should FAIL if security group has Cassandra Inter node TCP port 7000 open to public', function(done) {
