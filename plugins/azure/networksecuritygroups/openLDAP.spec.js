...
describe('openLDAP', function() {
    describe('run', function() {
        ...
        it('should PASS if security group has LDAP TCP port 389 not open to public', function(done) {
        ...
        it('should FAIL if security group has LDAP TCP port 389 open to public', function(done) {
