...
describe('openSSH', function() {
    describe('run', function() {
        ...
        it('should give passing result if TCP port 22 for SSH is not open to public', function(done) {
        ...
        it('should give failing result if TCP port 22 for SSH is open to public', function(done) {
