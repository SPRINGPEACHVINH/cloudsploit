...
var openDocker = require('./openDocker');
...
describe('openDocker', function() {
    describe('run', function() {
        ...
        it('should give passing result if Docker port 2375 or 2376 is not open to public', function(done) {
        ...
        it('should give failing result if Docker port 2375 or 2376 is open to public', function(done) {
