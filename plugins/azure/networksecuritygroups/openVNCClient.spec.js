...
var openVNCClient = require('./openVNCClient');
...
describe('openVNCClient', function() {
    describe('run', function() {
        ...
        it('should give passing result if TCP port 5500  for VNC Client is not open to public', function(done) {
        ...
        it('should give failing result if TCP port 5500  for VNC Client is open to public', function(done) {
