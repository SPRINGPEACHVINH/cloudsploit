...
var openTelnet = require('./openTelnet');
...
describe('openTelnet', function() {
    describe('run', function() {
        ...
        it('should give passing result if TCP port 23 for Telnet is not open to public', function(done) {
        ...
        it('should give failing result if TCP port 23 for Telnet is open to public', function(done) {
