...
var openMongoDB = require('./openMongoDB');
...
describe('openMongoDB', function() {
    describe('run', function() {
        ...
        it('should give passing result if TCP 27017 or 27018 or 27019 MongoDB port is not open to public', function(done) {
        ...
        it('should give failing result if TCP 27017 or 27018 or 27019 MongoDB port is open to public', function(done) {
