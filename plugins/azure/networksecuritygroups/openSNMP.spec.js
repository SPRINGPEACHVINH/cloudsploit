...
describe('openSNMP', function() {
    describe('run', function() {
        ...
        it('should give passing result if UDP 161 SNMP port is not open to public', function(done) {
        ...
        it('should give failing result if UDP 161 SNMP port is open to public', function(done) {
