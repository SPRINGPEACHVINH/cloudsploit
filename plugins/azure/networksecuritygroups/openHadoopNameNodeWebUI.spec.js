...
var openHadoopNameNodeWebUI = require('./openHadoopNameNodeWebUI');
...
describe('openHadoopNameNodeWebUI', function() {
    describe('run', function() {
        ...
        it('should give passing result if TCP port 50070 and 50470 for Hadoop/HDFS NameNode WebUI service is not open to public', function(done) {
        ...
        it('should give failing result if TCP port 50070 and 50470 for Hadoop/HDFS NameNode WebUI service is open to public', function(done) {
