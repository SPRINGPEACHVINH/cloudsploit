...
var openOracle = require('./openOracle');
...
describe('openOracle', function() {
    describe('run', function() {
        ...
        it('should give passing result if TCP port 1521 for Oracle is not open to public', function(done) {
        ...
        it('should give failing result if TCP port 1521 for Oracle is open to public', function(done) {
