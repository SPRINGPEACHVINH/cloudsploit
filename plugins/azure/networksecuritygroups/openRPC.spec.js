...
describe('openRPC', function() {
    describe('run', function() {
        ...
        it('should give passing result if TCP port 135 for RPC is not open to public', function(done) {
        ...
        it('should give failing result if TCP port 135 for RPC is open to public', function(done) {
