...
var openNetBIOS = require('./openNetBIOS');
...
describe('openNetBIOS', function() {
    describe('run', function() {
        ...
        it('should give passing result if UDP port 137 or 138 for NetBIOS is not open to public', function(done) {
        ...
        it('should give failing result if UDP port 137 or 138 for NetBIOS is open to public', function(done) {
