...
var openElasticsearch = require('./openElasticsearch');
...
describe('openElasticsearch', function() {
    describe('run', function() {
        ...
        it('should PASS if security group has Elasticsearch TCP port 9200 or 9300 not open to public', function(done) {
        ...
        it('should FAIL if security group has Elasticsearch TCP port 9200 or 9300 open to public', function(done) {
