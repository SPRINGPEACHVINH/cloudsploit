...
var openKibana = require('./openKibana');
...
describe('openKibana', function() {
    describe('run', function() {
        ...
        it('should give passing result if TCP port 5601 for Kibana is not open to public', function(done) {
        ...
        it('should give failing result if TCP port 5601 for Kibana is open to public', function(done) {
