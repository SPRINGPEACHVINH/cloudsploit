...
describe('openCIFS', function() {
    describe('run', function() {
        ...
        it('should give passing result if the UDP port 445 for CIFS is not open to public', function(done) {
        ...
        it('should give failing result if the UDP port 445 for CIFS is open to public', function(done) {
