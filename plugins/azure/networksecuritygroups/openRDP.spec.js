...
describe('openRDP', function() {
    describe('run', function() {
        ...
        it('should give passing result if TCP port 3389 for RDP is not open to public', function(done) {
        ...
        it('should give failing result if TCP port 3389 for RDP is open to public', function(done) {
