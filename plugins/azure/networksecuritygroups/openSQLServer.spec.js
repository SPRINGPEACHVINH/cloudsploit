...
var openSQLServer = require('./openSQLServer');
...
describe('openSQLServer', function() {
    describe('run', function() {
        ...
        it('should give passing result if TCP port 1433 or UDP port 1434 for SQL Server is not open to public', function(done) {
        ...
        it('should give failing result if TCP port 1433 or UDP port 1434 for SQL Server is open to public', function(done) {
