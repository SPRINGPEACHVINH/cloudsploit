...
var openLDAPS = require('./openLDAPS');
...
describe('openLDAPS', function() {
    describe('run', function() {
        ...
        it('should PASS if security group has LDAPS TCP port 636 not open to public', function(done) {
        ...
        it('should FAIL if security group has LDAPS TCP port 636 open to public', function(done) {
