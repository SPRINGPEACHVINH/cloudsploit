...
describe('openFTP', function() {
    describe('run', function() {
        ...
        it('should give passing result if TCP port 20 or 21 for FTP is not open to public', function(done) {
        ...
        it('should give failing result if TCP port 20 or 21 for FTP is open to public', function(done) {
