...
var openRedis = require('./openRedis');
...
describe('openRedis', function() {
    describe('run', function() {
        ...
        it('should give passing result if TCP 6379 Redis port is not open to public', function(done) {
        ...
        it('should give failing result if TCP 6379 Redis port is open to public', function(done) {
