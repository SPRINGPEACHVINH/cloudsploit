...
var openVNCServer = require('./openVNCServer');
...
describe('openVNCServer', function() {
    describe('run', function() {
        ...
        it('should give passing result if TCP port 5900 for VNC Server is not open to public', function(done) {
        ...
        it('should give failing result if TCP port 5900 for VNC Server is open to public', function(done) {
