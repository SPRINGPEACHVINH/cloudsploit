...
var openCassandraThrift = require('./openCassandraThrift');
...
const networkSecurityGroups = [
    ...
    },
    {
        ...
        "securityRules": [
        {
            "name": "AllowCassandraThrift",
            "id": "/subscriptions/ab12c345-def7-890g-a1b2-28fc0d22117e/resourceGroups/test-rg/providers/Microsoft.Network/networkSecurityGroups/aadds-nsg/securityRules/AllowCassandraThrift",
            "etag": "W/\"a1bb27cd-711f-4ede-b673-2fe8e7e07eee\"",
            "type": "Microsoft.Network/networkSecurityGroups/securityRules",
            "properties": {
                "provisioningState": "Succeeded",
...
describe('openCassandraThrift', function() {
    describe('run', function() {
        ...
        it('should PASS if security group has Cassandra Thrift TCP port 9160 not open to public', function(done) {
        ...
        it('should FAIL if security group has Cassandra Thrift TCP port 9160 open to public', function(done) {
