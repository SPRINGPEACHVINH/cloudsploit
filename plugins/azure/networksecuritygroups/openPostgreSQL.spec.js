...
var openPostgreSQL = require('./openPostgreSQL');
...
describe('openPostgreSQL', function() {
    describe('run', function() {
        ...
        it('should give passing result if TCP port 5432 for PostgreSQL is not open to public', function(done) {
        ...
        it('should give failing result if TCP port 5432 for PostgreSQL is open to public', function(done) {
