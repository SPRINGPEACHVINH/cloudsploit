...
describe('openSMTP', function() {
    describe('run', function() {
        ...
        it('should give passing result if TCP port 25 for SMTP is not open to public', function(done) {
        ...
        it('should give failing result if TCP port 25 for SMTP is open to public', function(done) {
