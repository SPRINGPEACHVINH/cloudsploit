...
var openSMBoTCP = require('./openSMBoTCP');
...
describe('openSMBoTCP', function() {
    describe('run', function() {
        ...
        it('should give passing result if TCP port 445 for Windows SMB over TCP is not open to public', function(done) {
        ...
        it('should give failing result if TCP port 445 for Windows SMB over TCP is open to public', function(done) {
