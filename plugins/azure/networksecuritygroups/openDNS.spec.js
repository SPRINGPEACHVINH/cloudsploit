...
describe('openDNS', function() {
    describe('run', function() {
        ...
        it('should give passing result if the TCP or UDP port 53 for DNS is not open to public', function(done) {
        ...
        it('should give failing result if the TCP or UDP port 53 for DNS is open to public', function(done) {
