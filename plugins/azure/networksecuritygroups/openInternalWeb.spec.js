...
var openInternalWeb = require('./openInternalWeb');
...
const networkSecurityGroups = [
    ...
    },
    {
        ...
        "securityRules": [
        {
            ...
            "id": "/subscriptions/ab12c345-def7-890g-a1b2-28fc0d22117e/resourceGroups/test-rg/providers/Microsoft.Network/networkSecurityGroups/aadds-nsg/securityRules/AllowInternalWeb",
            "etag": "W/\"a1bb27cd-711f-4ede-b673-2fe8e7e07eee\"",
            "type": "Microsoft.Network/networkSecurityGroups/securityRules",
            "properties": {
                "provisioningState": "Succeeded",
...
describe('openInternalWeb', function() {
    describe('run', function() {
        ...
        it('should PASS if security group has Internal Web TCP port 8080 not open to public', function(done) {
        ...
        it('should FAIL if security group has Internal Web TCP port 8080 open to public', function(done) {
