...
describe('rsaCertificateKeySize', function() {
    describe('run', function() {
        ...
        it('should give failing result if certificate does not have allowed key type', function(done) {
            ...
            auth.run(createCache(null, [listVaults[0]], { "/subscriptions/abcdef123-ebf6-437f-a3b0-28fc0d22117e/resourceGroups/Default-ActivityLogAlerts/providers/Microsoft.KeyVault/vaults/testvault": { data: [certificates] } }, { data: { ...certificatePolicy[2] } } ), {}, callback);
        });
    })
});
