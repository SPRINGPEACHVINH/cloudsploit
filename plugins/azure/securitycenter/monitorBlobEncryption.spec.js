...
var monitorBlobEncryption = require('./monitorBlobEncryption');
...
describe('monitorBlobEncryption', function() {
    describe('run', function() {
        ...
        it('should give passing result if Monitor Storage Blob Encryption enabled', function(done) {
        ...
        it('should give failing result if Monitor Storage Blob Encryption disabled', function(done) {
