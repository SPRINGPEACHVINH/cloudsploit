...
var monitorNsgEnabled = require('./monitorNsgEnabled');
...
describe('monitorNsgEnabled', function() {
    describe('run', function() {
        ...
        it('should give passing result if Monitor Network Security Groups enabled', function(done) {
        ...
        it('should give failing result if Monitor Network Security Groups disabled', function(done) {
