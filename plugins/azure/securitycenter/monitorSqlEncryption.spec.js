...
var monitorSqlEncryption = require('./monitorSqlEncryption');
...
describe('monitorSqlEncryption', function() {
    describe('run', function() {
        ...
        it('should give passing result if Monitor SQL Encryption enabled', function(done) {
        ...
        it('should give failing result if Monitor SQL Encryption disabled', function(done) {
