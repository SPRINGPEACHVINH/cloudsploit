...
var monitorSqlAuditing = require('./monitorSqlAuditing');
...
describe('monitorSqlAuditing', function() {
    describe('run', function() {
        ...
        it('should give passing result if Monitor SQL Auditing enabled', function(done) {
        ...
        it('should give failing result if Monitor SQL Auditing disabled', function(done) {
