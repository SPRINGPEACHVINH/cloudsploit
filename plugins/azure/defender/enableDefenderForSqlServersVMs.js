...
module.exports = {
    ...
    link: 'https://learn.microsoft.com/en-us/azure/defender-for-cloud/defender-for-sql-usage',
    apis: ['pricings:list'],
    ...
    run: function(cache, settings, callback) {
        ...
        async.each(locations.pricings, function(location, rcb) {
            ...
            helpers.checkMicrosoftDefender(pricings, 'sqlservervirtualmachines', 'SQL Servers on machines', results, location);
