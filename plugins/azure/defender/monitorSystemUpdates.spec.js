...
var monitorSystemUpdates = require('./monitorSystemUpdates');
...
describe('monitorSystemUpdates', function() {
    describe('run', function() {
        ...
        it('should give passing result if Monitor System Updates enabled', function(done) {
        ...
        it('should give failing result if Monitor System Updates disabled', function(done) {
