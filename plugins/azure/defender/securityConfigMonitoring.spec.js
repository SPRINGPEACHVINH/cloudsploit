...
var securityConfigMonitoring = require('./securityConfigMonitoring');
...
describe('securityConfigMonitoring', function() {
    describe('run', function() {
        ...
        it('should give passing result if Monitor Security Configuration enabled', function(done) {
        ...
        it('should give failing result if Monitor Security Configuration disabled', function(done) {
