...
var appWhitelistingEnabled = require('./appWhitelistingEnabled');
...
describe('appWhitelistingEnabled', function() {
    describe('run', function() {
        ...
        it('should give passing result if Monitor Adaptive Application Whitelisting enabled', function(done) {
        ...
        it('should give failing result if Monitor Adaptive Application Whitelisting disabled', function(done) {
