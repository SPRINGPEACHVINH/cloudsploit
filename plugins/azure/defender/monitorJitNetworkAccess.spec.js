...
var monitorJitNetworkAccess = require('./monitorJitNetworkAccess');
...
describe('monitorJitNetworkAccess', function() {
    describe('run', function() {
        ...
        it('should give passing result if Monitor JIT Network Access enabled', function(done) {
        ...
        it('should give failing result if Monitor JIT Network Access disabled', function(done) {
