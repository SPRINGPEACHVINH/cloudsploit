...
var scmSiteAccessRestriction = require('./scmSiteAccessRestriction');
...
describe('scmSiteAccessRestriction', function() {
    describe('run', function() {
        ...
        it('should give passing result if app Service has access restriction enabled for scm site', function(done) {
        ...
        it('should give failing result if App Service does not have access restriction enabled for scm site', function(done) {
