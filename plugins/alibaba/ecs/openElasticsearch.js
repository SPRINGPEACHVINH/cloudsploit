...
module.exports = {
    ...
    domain: 'Compute',
    severity: 'High',
    description: 'Ensure that security groups does not have TCP port 9200 for Elasticsearch open to the public.',
    ...
    recommended_action: 'Restrict TCP port 9200 for Elasticsearch to known IP addresses',
