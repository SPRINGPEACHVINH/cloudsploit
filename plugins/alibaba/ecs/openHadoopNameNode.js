...
module.exports = {
    ...
    domain: 'Compute',
    severity: 'Medium',
    description: 'Ensure that security groups does not have TCP port 8020 for HDFS NameNode metadata service open to the public.',
    ...
    recommended_action: 'Restrict TCP port 8020 for HDFS to known IP addresses',
