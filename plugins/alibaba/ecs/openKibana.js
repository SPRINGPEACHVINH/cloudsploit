...
module.exports = {
    ...
    domain: 'Compute',
    severity: 'Medium',
    description: 'Ensure that security groups does not have TCP port 5601 for Kibana open to the public.',
    ...
    recommended_action: 'Restrict TCP port 5601 for Kibana to known IP addresses',
