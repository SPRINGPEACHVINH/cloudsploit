...
module.exports = {
    ...
    domain: 'Compute',
    severity: 'High',
    description: 'Ensure that security groups does not have TCP port 20 or 21 for FTP open to the public.',
    ...
    recommended_action: 'Restrict TCP port 20 or 21 for FTP to known IP addresses',
