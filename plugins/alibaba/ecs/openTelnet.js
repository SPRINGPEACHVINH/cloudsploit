...
module.exports = {
    ...
    domain: 'Compute',
    severity: 'Medium',
    description: 'Ensure that security groups does not have TCP port 23 for Telnet open to the public.',
    ...
    recommended_action: 'Restrict TCP port 23 for Telnet to known IP addresses',
