...
var logServiceEnabled = require('./logServiceEnabled.js');
...
describe('logServiceEnabled', function () {
    describe('run', function () {
        it('should FAIL if Cluster does not have Log Service enabled', function (done) {
        ...
        it('should PASS if Cluster has Log Service enabled', function (done) {
