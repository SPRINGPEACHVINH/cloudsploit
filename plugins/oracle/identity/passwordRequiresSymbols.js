        ...
        authenticationPolicy.data.forEach(policy => {
            ...
            if (passwordPolicy &&
                ...
                helpers.addResult(results, 0,
                    'Password policy requires special characters', 'global', authenticationPolicy.data.compartmentId);
            } else {
                helpers.addResult(results, 1,
                    'Password policy does not require special characters', 'global', authenticationPolicy.data.compartmentId);
            }
