...
const plugin = require('./openOracle');
...
describe('openOracle', function () {
    describe('run', function () {
        ...
        it('should FAIL if security list has Oracle port open to public', function (done) {
            const callback = (err, results) => {
                expect(results.length).to.be.above(0)
        ...
        it('should FAIL if network security group has Oracle port open to public', function (done) {
            const callback = (err, results) => {
                expect(results.length).to.be.above(0)
