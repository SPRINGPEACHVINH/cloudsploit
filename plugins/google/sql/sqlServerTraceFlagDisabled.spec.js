...
var plugin = require('./sqlServerTraceFlagDisabled');
...
describe('sqlServerTraceFlagDisabled', function () {
    describe('run', function () {
        ...
        it('should give failing result if sql instance has 3625 (trace flag) enabled', function (done) {
            const callback = (err, results) => {
                expect(results.length).to.be.above(0);
