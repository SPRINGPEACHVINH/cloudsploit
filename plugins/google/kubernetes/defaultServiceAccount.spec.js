...
describe('defaultServiceAccount', function () {
    describe('run', function () {
        ...
        it('should give passing result if the default service account is not being used', function (done) {
            const callback = (err, results) => {
                expect(results.length).to.be.above(0);
                expect(results[0].status).to.equal(0);
        ...
        it('should give failing result if the default service account is being used', function (done) {
            const callback = (err, results) => {
                expect(results.length).to.be.above(0);
