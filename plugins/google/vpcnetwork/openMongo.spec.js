...
const openMongo = require('./openMongo');
...
const firewalls = [
    {
        ...
        "allowed": [{ "IPProtocol": "tcp", "ports": [ "27017" ]}],
        "direction": "INGRESS",
        "disabled": false,
...
describe('openMongo', function () {
    describe('run', function () {
        ...
        it('should FAIL if firewall rule has TCP port 27017 for Mongo is open to public', function (done) {
