...
const openCassandra = require('./openCassandra');
...
const firewalls = [
    {
        ...
        "allowed": [{ "IPProtocol": "tcp", "ports": [ "7001" ]}],
        "direction": "INGRESS",
        "disabled": false,
...
describe('openCassandra', function () {
    describe('run', function () {
        ...
        it('should FAIL if firewall rule has TCP port 7001 for Cassandra is open to public', function (done) {
