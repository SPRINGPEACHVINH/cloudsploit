...
const openMsSQL = require('./openMsSQL');
...
describe('openMsSQL', function () {
    describe('run', function () {
        ...
        it('should FAIL if firewall rule has TCP port 1433 for MSSQL is open to public', function (done) {
