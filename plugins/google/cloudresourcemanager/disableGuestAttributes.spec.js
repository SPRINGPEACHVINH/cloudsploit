...
var plugin = require('./disableGuestAttributes');
...
describe('disableGuestAttributes', function () {
    describe('run', function () {
        ...
        it('should give passing result if guest Attributes are not accessible by users', function (done) {
            const callback = (err, results) => {
                expect(results.length).to.be.above(0);
                expect(results[0].status).to.equal(0);
        ...
        it('should give failing result if guest Attributes are accessible by users', function (done) {
            const callback = (err, results) => {
                expect(results.length).to.be.above(0);
