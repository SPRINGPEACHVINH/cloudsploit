...
module.exports = {
    ...
    remediation_description: 'The "Disable Automatic IAM Grants for Default Service Accounts" constraint will be enforced at the organization level.',
    ...
    run: function(cache, settings, callback) {
        ...
        helpers.checkOrgPolicy(orgPolicies, 'iam.automaticIamGrantsForDefaultServiceAccounts', 'booleanPolicy', true, false, 'Disable Automatic IAM Grants for Default Service Accounts', results, organization);
    ...
    remediate: function(config, cache, settings, resource, callback) {
        ...
        var pluginName = 'disableAutomaticIAMGrants';
 
        var putCall = this.actions.remediate;

        helpers.remediateOrgPolicy(config, 'constraints/iam.automaticIamGrantsForDefaultServiceAccounts', 'booleanPolicy', true, resource, remediation_file, putCall, pluginName, function(err, action) {
