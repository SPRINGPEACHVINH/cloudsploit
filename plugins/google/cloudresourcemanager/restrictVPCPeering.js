...
module.exports = {
    ...
    recommended_action: 'Ensure that "Restrict VPC Peering" constraint is enforced at the organization level.',
    ...
    run: function(cache, settings, callback) {
        ...
        helpers.checkOrgPolicy(orgPolicies, 'compute.restrictVpcPeering', 'listPolicy', true, false, 'Restrict VPC Peering', results, organization);
