...
var plugin = require('./disableKeyUpload');
...
describe('disableKeyUpload', function () {
    describe('run', function () {
        ...
        it('should give passing result if service account key upload is disabled', function (done) {
            const callback = (err, results) => {
                expect(results.length).to.be.above(0);
                expect(results[0].status).to.equal(0);
        ...
        it('should give failing result if service account key upload is enabled', function (done) {
            const callback = (err, results) => {
                expect(results.length).to.be.above(0);
