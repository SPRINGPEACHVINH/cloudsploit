...
var plugin = require('./disableKeyCreation');
...
describe('disableKeyCreation', function () {
    describe('run', function () {
        ...
        it('should give passing result if service account key creation is disabled', function (done) {
            const callback = (err, results) => {
                expect(results.length).to.be.above(0);
                expect(results[0].status).to.equal(0);
        ...
        it('should give failing result if service account key creation is enabled', function (done) {
            const callback = (err, results) => {
                expect(results.length).to.be.above(0);
