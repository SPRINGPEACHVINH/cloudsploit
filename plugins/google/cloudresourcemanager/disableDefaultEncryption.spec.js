...
var plugin = require('./disableDefaultEncryption');
...
describe('disableDefaultEncryption', function () {
    describe('run', function () {
        ...
        it('should give passing result if default encryption is disabled', function (done) {
            const callback = (err, results) => {
                expect(results.length).to.be.above(0);
                expect(results[0].status).to.equal(0);
        ...
        it('should give failing result if default encryption is not disabled', function (done) {
            const callback = (err, results) => {
                expect(results.length).to.be.above(0);
