...
module.exports = {
    ...
    run: function(cache, settings, callback) {
        ...
        helpers.checkOrgPolicy(orgPolicies, 'compute.disableSerialPortAccess', 'booleanPolicy', true, false, 'Disable VM serial port access', results, organization);
    ...
    remediate: function(config, cache, settings, resource, callback) {
        ...
        var pluginName = 'disableSerialPortAccess';
 
        var putCall = this.actions.remediate;

        helpers.remediateOrgPolicy(config, 'constraints/compute.disableSerialPortAccess', 'booleanPolicy', true, resource, remediation_file, putCall, pluginName, function(err, action) {
