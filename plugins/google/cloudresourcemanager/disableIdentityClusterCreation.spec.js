...
var plugin = require('./disableIdentityClusterCreation');
...
describe('disableIdentityClusterCreation', function () {
    describe('run', function () {
        ...
        it('should give passing result if workload identity cluster creation is disabled', function (done) {
            const callback = (err, results) => {
                expect(results.length).to.be.above(0);
                expect(results[0].status).to.equal(0);
        ...
        it('should give failing result if workload identity cluster creation is enabled', function (done) {
            const callback = (err, results) => {
                expect(results.length).to.be.above(0);
