...
const asgMultiAz = require('./asgMultiAz');
...
describe('asgMultiAz', function () {
    describe('run', function () {
        it('should PASS if Auto Scaling group utilizes multiple availability zones', function (done) {
            const cache = createCache([autoScalingGroups[0]]);
            asgMultiAz.run(cache, {}, (err, results) => {
        ...
        it('should FAIL if Auto Scaling group utilizes one availability zone', function (done) {
