...
module.exports = {
    ...
    realtime_triggers: ['cognitoidentityserviceprovider:CreateUserPool','cognitoidentityserviceprovider:DeleteUserPool','wafv2:AssociateWebACL','wafv2:DisassociateWebACL'],
