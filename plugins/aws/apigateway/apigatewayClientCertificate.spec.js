...
var apigatewayClientCertificate = require('./apigatewayClientCertificate');
...
describe('apigatewayClientCertificate', function () {
    describe('run', function () {
        it('should PASS if API Gateway API use client certificate for all stages', function (done) {
            const cache = createCache([getRestApis[0]], getStages[0]);
            apigatewayClientCertificate.run(cache, {}, (err, results) => {
        ...
        it('should FAIL if API Gateway API does not use client certificate for all stages', function (done) {
