...
const objectLevelReadLogging = require('./objectLevelWriteEventLogging');
    ...
    describe('run', function () {
        ...
        it('should FAIL if S3 bucket doesnot have object-level logging for read events', function (done) {
            ...
            objectLevelReadLogging.run(cache, {}, (err, results) => {
                ...
                expect(results[0].message).to.include('Bucket does not has object-level logging for write events');
