...
var queueUnprocessedMessages = require('./queueUnprocessedMessages');
...
const getQueueAttributes = [
    {
        "Attributes": {
           ...
           "ApproximateNumberOfMessages":"60",
    ...
    },
    {
        "Attributes": {
           "QueueArn":"arn:aws:sqs:us-east-1:111122223333:akd-31-2",
           "ApproximateNumberOfMessages":"1100",
           "ApproximateNumberOfMessagesNotVisible":"0",
           "ApproximateNumberOfMessagesDelayed":"0",
           "CreatedTimestamp":"1609212146",
           "LastModifiedTimestamp":"1609212146",
...
describe('queueUnprocessedMessages', function () {
    describe('run', function () {
        it('should PASS if Amazon SQS queue has unporcessed messages less than the limit', function (done) {
            const cache = createCache([listQueues[0]], getQueueAttributes[0], null, null);
            queueUnprocessedMessages.run(cache, {}, (err, results) => {
        ...
        it('should FAIL if Amazon SQS queue has unporcessed messages more than the limit', function (done) {
