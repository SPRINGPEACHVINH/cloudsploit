...
const openMySQL = require('./openMySQL');
...
describe('openMySQL', function () {
    describe('run', function () {
        ...
        it('should FAIL if security group has MySQL TCP port open to public', function (done) {
        ...
        it('should WARN if security group is unused', function (done) {
            ...
            openMySQL.run(cache, {ec2_skip_unused_groups: 'true'}, (err, results) => {
                expect(results.length).to.equal(1);
