...
module.exports = {
    ...
    remediation_inputs: {
        openCassandraMonitoringReplacementIpAddress: {
        ...
        openCassandraMonitoringReplacementIpv6Address: {
    ...
    run: function(cache, settings, callback) {
        ...
        var service = 'Cassandra Monitoring';
    ...
    remediate: function(config, cache, settings, resource, callback) {
        ...
        var pluginName = 'openCassandraMonitoring';
        var protocol = 'tcp';
        var port = 7199;
