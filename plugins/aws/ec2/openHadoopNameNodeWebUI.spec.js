...
describe('openHadoopNameNodeWebUI', function () {
    describe('run', function () {
        ...
        it('should FAIL if security group has NameNodeWebUI TCP port open to public', function (done) {
        ...
        it('should WARN if security group is unused', function (done) {
            ...
            openHadoopNameNodeWebUI.run(cache, {ec2_skip_unused_groups: 'true'}, (err, results) => {
                expect(results.length).to.equal(1);
