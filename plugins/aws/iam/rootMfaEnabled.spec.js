...
const rootMfaEnabled = require('./rootMfaEnabled');
...
describe('rootMfaEnabled', function () {
    describe('run', function () {
        it('should PASS if an MFA device was found for the root account', function (done) {
