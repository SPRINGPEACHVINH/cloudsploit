...
const roles = [
    ...
    },
    {
        ...
        "AssumeRolePolicyDocument": "%7B%22Version%22%3A%222012-10-17%22%2C%22Statement%22%3A%5B%7B%22Effect%22%3A%22Allow%22%2C%22Principal%22%3A%7B%22AWS%22%3A%22arn%3Aaws%3Aiam%3A%111122223333%3Aroot%22%7D%2C%22Action%22%3A%22sts%3AAssumeRole%22%2C%22Condition%22%3A%7B%22Bool%22%3A%7B%22aws%3AMultiFactorAuthPresent%22%3A%22true%22%7D%7D%7D%5D%7D",
        "MaxSessionDuration": 3600
    },
    {
        "Path": "/",
    ...
    },
    {
        ...
        "AssumeRolePolicyDocument": "%7B%22Version%22%3A%222012-10-17%22%2C%22Statement%22%3A%5B%7B%22Effect%22%3A%22Allow%22%2C%22Principal%22%3A%7B%22AWS%22%3A%22arn%3Aaws%3Aiam%3A%3A111222333444%3Aroot%22%7D%2C%22Action%22%3A%22sts%3AAssumeRole%22%2C%22Condition%22%3A%7B%22Bool%22%3A%7B%22aws%3AMultiFactorAuthPresent%22%3A%22true%22%7D%7D%7D%5D%7D",
        "MaxSessionDuration": 3600
    },
    {
        "Path": "/",
        ...
        "AssumeRolePolicyDocument": "%7B%22Version%22%3A%222012-10-17%22%2C%22Statement%22%3A%5B%7B%22Effect%22%3A%22Allow%22%2C%22Principal%22%3A%7B%22AWS%22%3A%22arn%3Aaws%3Aiam%3A%3A111222333444%3Aroot%22%7D%2C%22Action%22%3A%22sts%3AAssumeRole%22%2C%22Condition%22%3A%7B%7D%7D%5D%7D",
        "MaxSessionDuration": 3600
    },
    {
        "Path": "/",
...
describe('crossAccountMfaExtIdAccess', function () {
    describe('run', function () {
        ...
        it('should PASS if cross-account role requires MFA/external ID for all accounts', function (done) {
            const cache = createCache([roles[3]]);
            crossAccountMfaExtIdAccess.run(cache, {}, (err, results) => {
                expect(results.length).to.equal(1);
        ...
        it('should PASS if IAM role does not contain cross-account statements', function (done) {
        ...
        it('should PASS if IAM role does not contain trust relationship statements', function (done) {
            const cache = createCache([roles[5]]);
            crossAccountMfaExtIdAccess.run(cache, {}, (err, results) => {
                expect(results.length).to.equal(1);
                expect(results[0].status).to.equal(0);
                expect(results[0].region).to.equal('global');
