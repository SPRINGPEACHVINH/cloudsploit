...
var appmeshVGHealthChecks = require('./appmeshVGHealthChecks'); // Replace with your plugin filename
...
describe('appmeshVGHealthChecks', function () {
    describe('run', function () {

        it('should PASS if health check policies are configured for Amazon App Mesh virtual gateways', function (done) {
            const cache = createCache([listMeshes[0]], [listVirtualGateways[0]], describeVirtualGateway[0]);
            appmeshVGHealthChecks.run(cache, {}, (err, results) => {
        ...
        it('should FAIL if health check policies are not configured for Amazon App Mesh virtual gateways', function (done) {
