...
const redshiftClusterMasterUsername = require('./redshiftClusterMasterUsername');
...
describe('redshiftClusterMasterUsername', function () {
    describe('run', function () {
        it('should PASS if Redshift cluster is using default "awsuser" master username', function (done) {
            const cache = createCache([describeClusters[0]]);
            redshiftClusterMasterUsername.run(cache, {}, (err, results) => {
        ...
        it('should FAIL if Redshift cluster is not using default "awsuser" master username', function (done) {
