...
const snapshotRetentionPeriod = require('./snapshotRetentionPeriod');
...
describe('snapshotRetentionPeriod', function () {
    describe('run', function () {
        it('should PASS if Redshift cluster has retention period set', function (done) {
            const cache = createCache([describeClusters[0]]);
            snapshotRetentionPeriod.run(cache, {}, (err, results) => {
        ...
        it('should FAIL if Redshift cluster does not have retention period set', function (done) {
