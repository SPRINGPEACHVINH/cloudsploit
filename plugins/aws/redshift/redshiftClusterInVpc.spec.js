...
const redshiftClusterInVpc = require('./redshiftClusterInVpc');
...
describe('redshiftClusterInVpc', function () {
    describe('run', function () {
        it('should PASS if Redshift cluster is launched within a VPC', function (done) {
            const cache = createCache([describeClusters[0]]);
            redshiftClusterInVpc.run(cache, {}, (err, results) => {
        ...
        it('should FAIL if Redshift cluster is not launched within a VPC', function (done) {
